...
https://my.glove80.com/#/layout/user/8fc56c3a-617d-4c0e-be28-9862dadc8307

make thumb r1 mod tap gui space not hyper space

NOTE: this was my last keyboard keymap from the moergo online web editorkj
...
/ {
 ...
 &magic LAYER_Magic 0  &kp HOME  &kp END  &kp LEFT  &kp RIGHT          &mt LGUI BSPC  &mt LS(LC(LG(LA(LGUI)))) DEL  &kp LALT  &kp RALT  &mt RS(RC(RA(RGUI))) RET  &mt RGUI SPACE          &kp UP   &kp DOWN  &kp LBKT  &kp RBKT  &kp PG_DN
            >;
        };
